...
# CONFIGURAÇÕES
ARQUIVO_HTML = "/var/www/meusite/palpite-do-bicho-caminho-da-sorte.html"
CHAVE = "<!--MARCA_AQUI-->"
...
PUXADAS_PADRAO = [7, 16, 25, 21, 14, 22] 
...
if os.path.exists(ARQUIVO_HTML):
    ...
    if len(partes) >= 3:
        ...
        os.system(f'cd /var/www/meusite && git commit -m "Auto Update Caminho {data_str}"')
