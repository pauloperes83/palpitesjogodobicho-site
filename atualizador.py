...
<title>{title}</title>
<meta name="description" content="Confira o melhor {kw}. Análise completa com milhares, centenas e dezenas para o Jogo do Bicho Rio e Look.">
{css}</head><body>
<header><div class="container"><a href="index.html" class="logo"><img src="images/logo-palpites.png" alt="Águia Prime Palpites"></a></div></header>
...
<footer class="site-footer"><div class="container">
    ...
    with open("/var/www/meusite/palpite-do-bicho-rj.html", 'w', encoding='utf-8') as f:
        f.write(build_page(f"Palpite do Jogo do Bicho de Hoje Rio de Janeiro {hoje}", f"Palpite do dia do Jogo do Bicho de hoje Rio {hoje}", "https://app.aguiaprime119000.com/pr/y8X6LEBU", "🎰 APOSTAR NO RIO"))
    
    with open("/var/www/meusite/palpite-do-bicho-look.html", 'w', encoding='utf-8') as f:
        f.write(build_page(f"Palpite da Look Loterias de Hoje Goiás {hoje}", f"Palpite da Look Loterias de hoje Goiás {hoje}", "https://app.valedasorteloterias.club/pr/g5P71dlw", "🎰 APOSTAR NA LOOK"))
